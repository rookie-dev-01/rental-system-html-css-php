...
session_start();
							...
							$sql="SELECT  * FROM product WHERE pcategory='$pcategory' OR psubcategory='$pcategory'";
		...
		<div id="page">
			...
			<div id="marketing" class="container">
				...
				echo 
					'<div class="3u">
						<section>
							<header><h2>'.$row['pname'].'</h2></header>
							<p> ';
								echo '<td <align=\'centre\'><img  height="200px" width="250px" style="border-radius:10px;" src="data:image;base64,'.$row['pimage'].' ">
								<p><b>By : '.$row['emailid'].'</b></p>
								<a href="details.php?category='.$row['pname'].'" class="button">Details</a>
