				...
				echo 
					'<div class="3u">
						<section>
							...
							<p> ';
								echo '<td <align=\'centre\'><img  height="200px" width="250px" style="border-radius:10px;" src="data:image;base64,'.$row['pimage'].' ">
								<p><b>Price : '.$row['pprice'].'</b></p>
								<p><b>Duration : '.$row['pduration'].'</b></p>
								<p><b>Description : '.$row['pdescription'].'</b></p>
								<p><b>Terms&Conditions : '.$row['pconditions'].'</b></p>
								<a href="contactdetails.php?emailid='.$row['emailid'].'" class="button">Renter Details</a>
